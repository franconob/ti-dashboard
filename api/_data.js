/**
 * Shared data module for Vercel serverless functions.
 * Uses a seeded PRNG (mulberry32) so the 500 indicators are identical
 * across cold starts, giving a consistent demo experience.
 */
...
function randomDate(daysBack) {
  ...
  return new Date(past + random() * (now - past)).toISOString();
}
